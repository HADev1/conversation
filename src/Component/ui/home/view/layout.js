    ...
    <>
      <main>
        <div class="layout">
          ...
          {/* <!-- End of Navigation -->
				<!-- Start of Sidebar --> */}
          <div class="sidebar home_sidebar" id="sidebar">
            <div class="container">
              <div class="col-md-12">
                  ...
                  <div class="tab-pane fade" id="members">
                    ...
                    <div class="contacts">
                      ...
                      <div class="list-group" id="contacts" role="tablist">
                        <a
                          href="#"
                          class="filterMembers all online contact"
                          data-toggle="list"
                        >
                          <img
                            class="avatar-md"
                        ...
                        <a
                          href="#"
                          class="filterMembers all offline contact"
                          data-toggle="list"
                        >
                          <img
                            class="avatar-md"
                      ...
                      <div class="list-group" id="chats" role="tablist">
                        ...
                        >
                          ...
                          <div class="data">
                            ...
                            <span>Mon</span>
                            <p>
                              A new feature has been updated to your account.
                              Check it out...
                            </p>
                          </div>
                        </a>
                        ...
                        >
                          ...
                          <div class="data">
                            ...
                            <span>Sun</span>
                            <p>
                              How can i improve my chances of getting a deposit?
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div class="data">
                            ...
                            <span>Mon</span>
                            <p>
                              No more running out of the office at 4pm on
                              Fridays!
                            </p>
                          </div>
                        </a>
                        ...
                        >
                          ...
                          <div class="data">
                            ...
                            <span>Fri</span>
                            <p>
                              All your favourite books at your reach! We are now
                              mobile.
                            </p>
                          </div>
                        </a>
                        ...
                        >
                          ...
                          <div class="data">
                            ...
                            <span>Feb 9</span>
                            <p>
                              Dear Deborah, your Thai massage is today at 5pm.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div class="data">
                            ...
                            <span>Thu</span>
                            <p>
                              Unfortunately your session today has been
                              cancelled!
                            </p>
                          </div>
                        </a>
                    ...
                    <div class="notifications">
                      ...
                      <div class="list-group" id="alerts" role="tablist">
                        ...
                        >
                          ...
                          <div class="data">
                            <p>
                              Mildred has a birthday today. Wish him all the
                              best.
                            </p>
                    ...
                    <div class="settings">
                      ...
                      <div class="categories" id="accordionSettings">
                        ...
                        <div class="category">
                          ...
                          >
                            <i class="material-icons md-30 online">
                              person_outline
                            </i>
                            <div class="data">
                              <h5>My Account</h5>
                          ...
                          >
                            <div class="content layer">
                              <div class="history">
                                ...
                                <p>
                                  The messages won't be deleted or cleared on
                                  the devices of the people you chatted with.
                                </p>
                                ...
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <label
                                    ...
                                    for="save-info"
                                  >
                                    Delete will remove your chat history from
                                    the device.
                                  </label>
                                </div>
                                <button type="submit" class="btn button w-100">
                            ...
                            <div class="content no-layer">
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    You can set up Swipe to receive
                              ...
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    If enabled shows a red badge on the Swipe
                              ...
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    Flashes the Swipe app on mobile in your
                              ...
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    When someone send you a text message you
                                    will receive alert via notification light.
                                  </p>
                                </div>
                                <label class="switch">
                                  <input type="checkbox" />
                            ...
                            <div class="content no-layer">
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    The dark mode is applied to core areas of
                                    the app that are normally displayed as
                                    light.
                                  </p>
                                </div>
                                <label class="switch">
                            ...
                            <div class="content no-layer">
                              <div class="set">
                                <div class="details">
                                  <h5>Keep Me Safe</h5>
                                  <p>
                                    Automatically scan and delete direct
                                    messages you receive from everyone that
                                    contain explict content.
                                  </p>
                                </div>
                                <label class="switch">
                                  <input type="checkbox" />
                              ...
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    If enabled scans direct messages from
                                    everyone unless they are listed as your
                                    friend.
                                  </p>
                                </div>
                                <label class="switch">
                              ...
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    Only your friends or your mutual friends
                                    will be able to send you a friend reuqest.
                                  </p>
                                </div>
                                <label class="switch">
                                  <input type="checkbox" checked />
                              ...
                              <div class="set">
                                <div class="details">
                                  ...
                                  <p>
                                    ...
                                    information to customize Swipe for you.
                                  </p>
                                </div>
                                <label class="switch">
                                  <input type="checkbox" />
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <button class="dropdown-item connect" name="1">
                                <i class="material-icons">phone_in_talk</i>Voice
                                Call
                              </button>
                              <button class="dropdown-item connect" name="1">
                        ...
                        <div class="message me">
                          <div class="text-main">
                            <div class="text-group me">
                              <div class="text me">
                                <p>
                                  Can't wait! How are we coming along with the
                                  client?
                                </p>
                              </div>
                            </div>
                        ...
                        <div class="message me">
                          <div class="text-main">
                            ...
                            <div class="text-group me">
                              <div class="text me">
                                <p>
                                  I have already started gathering some stuff
                                  for the mood boards, excited to start!
                                </p>
                              </div>
                            </div>
                            <span>10:21 PM</span>
                            ...
                            <div class="text-group">
                              <div class="text">
                                <p>
                                  ...
                                  task. We may need to make some adjustments to
                                  the last couple of items - but no biggie!
                                </p>
                              </div>
                            </div>
                            <span>11:07 PM</span>
                        ...
                        <div class="message me">
                          <div class="text-main">
                            <div class="text-group me">
                              <div class="text me">
                                <p>
                                  Well done all. See you all at 2 for the
                                  kick-off meeting.
                                </p>
                              </div>
                            </div>
                        ...
                        <div class="message me">
                          <div class="text-main">
                            <div class="text-group me">
                              <div class="text me">
                                <p>
                                  Hope you're all ready to tackle this great
                    ...
                    <div class="container">
                      <div class="col-md-12">
                        <div class="no-messages">
                          ...
                          <p>
                            Seems people are shy to start the chat. Break the
                            ice send the first message.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="container">
                      <div class="col-md-12">
                        <div class="inside">
                          ...
                          <button
                            class="btn disabled d-md-block d-none"
                            disabled
                          >
                            <i class="material-icons md-30">phone_in_talk</i>
                          </button>
                          ...
                          <button
                            class="btn d-md-block disabled d-none"
                            disabled
                          >
                            <i class="material-icons md-30">info</i>
                          </button>
