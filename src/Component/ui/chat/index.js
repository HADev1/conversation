      ...
      <div className="container">
        <div className="inside">
          <div className="nav nav-tab menu">
            ...
            {/* <a href="#discussions" data-toggle="tab" className="active">
            ...
            <button className="btn power" onclick="visitPage();">
        ...
        <div className="list-group" id="chats" role="tablist">
          ...
          >
            ...
            <div className="data">
              ...
              <span>Mon</span>
              <p>
                A new feature has been updated to your account. Check it out...
              </p>
            </div>
          </a>
          <a
    ...
    <div id="notifications" className="tab-pane fade">
      <div className="search">
        <form className="form-inline position-relative">
          ...
          />
          <button type="button" className="btn btn-link loop">
            <i className="material-icons filter-list">filter_list</i>
          </button>
        </form>
      </div>
      <div className="list-group sort">
            ...
            >
              <div className="content layer">
                <div className="history">
                  <p>
                    When you clear your conversation history, the messages will
                    be deleted from your own device.
                  </p>
                  <p>
                    The messages won't be deleted or cleared on the devices of
              ...
              <div className="content no-layer">
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      You can set up Swipe to receive notifications when you
                      have new messages.
                    </p>
                  </div>
                ...
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      If enabled shows a red badge on the Swipe app icon when
                ...
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      Flashes the Swipe app on mobile in your taskbar when you
                ...
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      Set the app to alert you via notification sound when you
                ...
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      When someone send you a text message you will receive
                      alert via notification light.
                    </p>
                  </div>
                  <label className="switch">
                    <input type="checkbox" />
              ...
              <div className="content no-layer">
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      ...
                      from everyone that contain explict content.
                    </p>
                  </div>
                  <label className="switch">
                    <input type="checkbox" />
                ...
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      If enabled scans direct messages from everyone unless they
                      are listed as your friend.
                    </p>
                  </div>
                  <label className="switch">
                    <input type="checkbox" checked />
                ...
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      If enabled anyone in or out your friends of friends list
                ...
                <div className="set">
                  <div className="details">
                    ...
                    <p>
                      Only your friends or your mutual friends will be able to
                      send you a friend reuqest.
                    </p>
                  </div>
                  <label className="switch">
                    <input type="checkbox" checked />
            ...
            <div className="message">
              ...
              <div className="text-main">
                <div className="text-group">
                  <div className="text">
                    <p>
                      Coming along nicely, we've got a draft for the client
                      quarries completed.
                    </p>
                  </div>
                </div>
            ...
            <div className="message me">
              <div className="text-main">
                ...
                <div className="text-group me">
                  <div className="text me">
                    <p>
                      I have already started gathering some stuff for the mood
            ...
            <div className="message">
              ...
              <div className="text-main">
                <div className="text-group">
                  <div className="text">
                    <p>
                      Great start guys, I've added some notes to the task. We
            ...
            <div className="message me">
              <div className="text-main">
                <div className="text-group me">
                  <div className="text me">
                    <p>
                      Hope you're all ready to tackle this great project. Let's
                      smash some Brand Concept & Design!
                    </p>
                  </div>
                </div>
                <span>
                  <i className="material-icons">check</i>10:21 PM
                </span>
              </div>
            </div>
            <div className="message">
